...
public class CurrentConstants {
	...
	public static final Font TAB_FONT = new Font(FONT_STYLE, Font.BOLD, 12);	
	...
	public static final Font COUNTABLE_BLOCK_DELETE_FONT = new Font(FONT_STYLE, Font.BOLD, 11);
